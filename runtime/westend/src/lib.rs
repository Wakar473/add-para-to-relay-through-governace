...
use beefy_primitives::crypto::AuthorityId as BeefyId; use sp_runtime::Permill;
use frame_election_provider_support::{onchain, SequentialPhragmen};
use frame_support::{
	construct_runtime, parameter_types,
	traits::{ConstU32, InstanceFilter, KeyOwnerProofSystem, WithdrawReasons,EitherOfDiverse},
...
construct_runtime! {
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
        ...
        Democracy: pallet_democracy::{Pallet, Call, Storage, Config<T>, Event<T>} = 33,
		Treasury: pallet_treasury::{Pallet, Call, Storage, Config, Event<T>} = 34,
		// Pallet for sending XCM.
		XcmPallet: pallet_xcm::{Pallet, Call, Storage, Event<T>, Origin, Config} = 99,
		Society: pallet_society::{Pallet, Call, Storage, Event<T>} = 102,
		Bounties: pallet_bounties::{Pallet, Call, Storage, Event<T>} = 125,
		//ChildBounties: pallet_child_bounties = 127
		 ChildBounties: pallet_child_bounties = 121,
