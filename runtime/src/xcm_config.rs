...
parameter_types! {
	...
	pub const Ourchain1: MultiLocation = Parachain(2000).into();
	pub const Ourchain2: MultiLocation = Parachain(2001).into();

	pub const RococoForOurchain1: (MultiAssetFilter, MultiLocation) = (Rococo::get(), Ourchain1::get());
	pub const RococoForOurchain2: (MultiAssetFilter, MultiLocation) = (Rococo::get(), Ourchain2::get());
}

pub type TrustedTeleporters = (

	xcm_builder::Case<RococoForOurchain1>,
