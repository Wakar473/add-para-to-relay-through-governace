...
parameter_types! {
	pub CouncilMotionDuration: BlockNumber = prod_or_fast!(1 * MINUTES, 1 * MINUTES, "DOT_MOTION_DURATION");
...
parameter_types! {
	...
	pub TermDuration: BlockNumber = prod_or_fast!(1 * MINUTES, 1 * MINUTES, "DOT_TERM_DURATION");
...
parameter_types! {
	...
	pub const BountyUpdatePeriod: BlockNumber = 1 * MINUTES;
...
parameter_types! {
	...
	pub LeasePeriod: BlockNumber = prod_or_fast!(1 * MINUTES,0, "DOT_LEASE_PERIOD");
	...
	pub LeaseOffset: BlockNumber = prod_or_fast!(1 * MINUTES, 0, "DOT_LEASE_OFFSET");
}
